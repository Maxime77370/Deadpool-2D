...
def_ecran = 11 #choisir la definition de votre ecran entre 0 et 19
type_ecran = [FULLSCREEN, RESIZABLE, NOFRAME]
def_type_ecran = 1


def init_fenetre():
	debut = time.time()
	fenetre = pygame.display.set_mode((fenetre_x[def_ecran],fenetre_y[def_ecran]), type_ecran[def_type_ecran]) #création d'une fenetre
