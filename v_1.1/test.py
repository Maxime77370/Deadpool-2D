...
personnage_y = fenetre_y[def_ecran] / 2 + 200
...
while True:
	...
	personnage_var = annimation_personnage(personnage_vitesse_par_s, personnage_x, personnage_y,annimation_nb,t_reel,animation_perso_respiration_1,animation_perso_respiration_2,animation_perso_coure_1,animation_perso_coure_2,animation_perso_coure_3,animation_perso_coure_4,fenetre_x,fenetre_y,def_ecran,fenetre,fps)
	personnage = personnage_var[0]
	personnage_x = personnage_var[1]
	personnage_y = personnage_var[2]
	position_personnage = personnage_var[3]
	...
	fps_var = frame_par_seconde(debut_boucle, fin_boucle, debut_demarage)
	fps = fps_var[0]
	t_reel = fps_var[1]